...
function generateEventEmail(body) {
      ...
      state, zip, eventDateTime, date, time, photoshootLengh, retouchPrice, photosPrice,
        													...
        													<tr>
        														<td style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px 10px;font-family:arial,helvetica,sans-serif;" align="left">
        															...
        															<div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
        																<p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="font-size: 18px; line-height: 25.2px; color: #4a4a4a;"><strong>${fname}, your event session has </strong></span></p>
        							...
        							<tr>
        								<td style="overflow-wrap:break-word;word-break:break-word;padding:20px 20px 40px;font-family:arial,helvetica,sans-serif;" align="left">
        									...
        									<div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
        										...
        										<br>
        										<p style="font-size: 15px; line-height: 140%; text-align: center;"><span style="font-size: 14px; line-height: 16.8px;"><strong><span style="color: #4a4a4a; line-height: 16.8px; font-size: 14px;"><b>Event location:</b> ${streetNum} ${city}, ${state} ${zip}</span></strong></span></p>
        										<br>
        										...
        										<br>
        										<br>
        										<p style="font-size: 15px; line-height: 140%; text-align: center;"><span style="font-size: 14px; line-height: 16.8px;"><strong><span style="color: #4a4a4a; line-height: 16.8px; font-size: 14px;"><b>Event Fee:</b> $100.00</span></strong></span></p>

        										<p style="font-size: 15px; line-height: 140%; text-align: center;"><span style="font-size: 14px; line-height: 16.8px;"><strong><span style="color: #4a4a4a; line-height: 16.8px; font-size: 14px;"><b>Event Length:</b> $${eventLength}.00</span></strong></span></p>
        										...
        										<br>
        										<p style="font-size: 15px; line-height: 140%; text-align: center;"><span style="font-size: 14px; line-height: 16.8px;"><strong><span style="color: #4a4a4a; line-height: 16.8px; font-size: 14px;"><b>Total:</b> $${eventTotal}.00</span></strong></span></p>
